...
CREATE TABLE `V3_item_resource` (
  ...
  `year` int(11) NOT NULL,
  `res_kg_gdp` bigint(11) DEFAULT NULL,
  `c_kg_val` float(16,4) DEFAULT NULL,
...
INSERT INTO `V3_item_resource` VALUES ('AVO','CO2',2014,NULL,NULL,NULL,NULL,NULL),('COW','CO2',2014,NULL,NULL,NULL,NULL,NULL),('CPE','CO2',2014,NULL,NULL,NULL,NULL,NULL),('MIL','CO2',2014,NULL,NULL,NULL,NULL,NULL),('PER','CO2',2014,NULL,NULL,NULL,NULL,NULL),('WHT','CO2',2014,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2017-11-21 12:18:12
