...
INSERT INTO `V3_entity_item` VALUES ('ARGNAT','AVO',2014,3877000,2686838,0.6930,0.0613,0.0884);
INSERT INTO `V3_entity_item` VALUES ('ARGNAT','COW',2014,2821700000,7037021448,2.4939,160.4794,64.3489);
INSERT INTO `V3_entity_item` VALUES ('ARGNAT','CPE',2014,54508000,26385703,0.4841,0.6017,1.2431);
INSERT INTO `V3_entity_item` VALUES ('ARGNAT','MIL',2014,11009900000,3435760403,0.3121,78.3526,251.0810);
INSERT INTO `V3_entity_item` VALUES ('ARGNAT','PER',2014,771271000,315319521,0.4088,7.1909,17.5888);
INSERT INTO `V3_entity_item` VALUES ('ARGNAT','WHT',2014,9315049000,1469747061,0.1578,33.5176,212.4299);
INSERT INTO `V3_entity_item` VALUES ('ECOCHE','AVO',2014,10950,7588,0.6930,NULL,0.6000);
INSERT INTO `V3_entity_item` VALUES ('ECOCHE','COW',2014,0,0,NULL,NULL,0.0000);
INSERT INTO `V3_entity_item` VALUES ('ECOCHE','CPE',2014,18250,8835,0.4841,NULL,1.0000);
INSERT INTO `V3_entity_item` VALUES ('ECOCHE','MIL',2014,206225,64363,0.3121,NULL,11.3000);
INSERT INTO `V3_entity_item` VALUES ('ECOCHE','PER',2014,36500,14921,0.4088,NULL,2.0000);
INSERT INTO `V3_entity_item` VALUES ('ECOCHE','WHT',2014,18250,2880,0.1578,NULL,1.0000);
...
INSERT INTO `V3_entity_item_copy` VALUES ('ECOCHE','AVO',2014,10950,7588,0.6930,0.4158,10950.0000,10950.0000,0.6000);
INSERT INTO `V3_entity_item_copy` VALUES ('ECOCHE','COW',2014,0,0,2.4939,0.0000,0.0000,0.0000,0.0000);
INSERT INTO `V3_entity_item_copy` VALUES ('ECOCHE','CPE',2014,18250,8835,0.4841,0.4841,18250.0000,18250.0000,1.0000);
INSERT INTO `V3_entity_item_copy` VALUES ('ECOCHE','MIL',2014,206225,64363,0.3121,3.5267,206225.0000,206225.0000,11.3000);
INSERT INTO `V3_entity_item_copy` VALUES ('ECOCHE','PER',2014,36500,14921,0.4088,0.8176,36500.0000,36500.0000,2.0000);
INSERT INTO `V3_entity_item_copy` VALUES ('ECOCHE','WHT',2014,18250,2880,0.1578,0.1578,18250.0000,18250.0000,1.0000);
...
--
-- Table structure for table `V3_entity_service_copy`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `V3_entity_service_copy` (
  `entity_name` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `service_name` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unique_pop` bigint(16) NOT NULL,
...
--
-- Dumping data for table `V3_entity_service_copy`
--

INSERT INTO `V3_entity_service_copy` VALUES ('ECOCHE','ECOMEAL',18250,18250,1,2014,5295693824.000000,290175.000000,290175.000000,15.900000);
...
INSERT INTO `V3_service_item` VALUES ('ECOMEAL','AVO',0.6000);
INSERT INTO `V3_service_item` VALUES ('ECOMEAL','COW',0.0000);
INSERT INTO `V3_service_item` VALUES ('ECOMEAL','CPE',1.0000);
INSERT INTO `V3_service_item` VALUES ('ECOMEAL','MIL',11.3000);
INSERT INTO `V3_service_item` VALUES ('ECOMEAL','PER',2.0000);
INSERT INTO `V3_service_item` VALUES ('ECOMEAL','WHT',1.0000);
...
-- Dump completed on 2018-02-02 18:33:34
